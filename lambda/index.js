...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Bienvenido a Youtube Music';
        const repromptSpeakOutput = 'Puedes decir, reproduce Linkin Park, para comenzar'
...
const PlaySongIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        if (speechText) {
            ...
            return handlerInput.responseBuilder
                .speak("Para comenzar puedes decir, reproduce Linkin Park.")
                .getResponse();
        }
    },
...
const controller = {
    ...
    async play(handlerInput, audioInfo) {
      ...
      responseBuilder
        .speak(`Reproduciendo  ${audioInfo.snippet.title}`)
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = '¡Puedes saludarme! ¿Cómo puedo ayudarte?';
